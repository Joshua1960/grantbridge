...
export default function FunderSettingsPage() {
  ...
  const [avatarUrl, setAvatarUrl] = useState(user?.avatar || "https://images.unsplash.com/photo-1560250097-0b93528c311a?w=400&h=400&fit=crop&crop=face");
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { key: "projectUpdates", label: "Project Updates", desc: "Get notified about projects you've funded" },
                    { key: "fundingAlerts", label: "Funding Alerts", desc: "Alerts when projects reach funding milestones" },
                    { key: "weeklyDigest", label: "Weekly Digest", desc: "Weekly summary of activity and opportunities" },
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { key: "showInvestments", label: "Show Investments", desc: "Display your funded projects publicly" },
                    { key: "allowMessages", label: "Allow Messages", desc: "Let entrepreneurs send you messages" },
