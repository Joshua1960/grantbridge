          ...
          <div className="bg-white rounded-3xl shadow-2xl border border-slate-100 p-8 sm:p-10">
            ...
            <div className="space-y-4">
              ...
              <Button
                ...
                icon={isLoggingIn ? undefined : <ArrowRight size={18} />}
              >
            ...
            <div className="grid grid-cols-2 gap-3">
              <button className="flex items-center justify-center gap-2 px-4 py-3 border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors cursor-pointer">
