...
export default function FunderSidebar({ isOpen, onClose }: FunderSidebarProps) {
  ...
  return (
    <aside
      className={`fixed inset-y-0 left-0 z-50 w-67.5 bg-white border-r border-slate-100 transform transition-transform duration-300 lg:translate-x-0 lg:static lg:z-auto flex flex-col ${isOpen ? "translate-x-0" : "-translate-x-full"}`}
    >
      {/* Logo */}
